...
import static dev.maxrave.pipepipe.extractor.services.soundcloud.SoundcloudParsingHelper.clientId;
import static dev.maxrave.pipepipe.extractor.services.soundcloud.SoundcloudParsingHelper.getAllImagesFromTrackObject;
import static dev.maxrave.pipepipe.extractor.stream.AudioStream.UNKNOWN_BITRATE;
import static dev.maxrave.pipepipe.extractor.stream.Stream.ID_UNKNOWN;
...
import dev.maxrave.pipepipe.extractor.exceptions.GeographicRestrictionException;
import dev.maxrave.pipepipe.extractor.exceptions.ParsingException;
import dev.maxrave.pipepipe.extractor.exceptions.SoundCloudGoPlusContentException;
...
import dev.maxrave.pipepipe.extractor.stream.DeliveryMethod;
import dev.maxrave.pipepipe.extractor.stream.Description;
import dev.maxrave.pipepipe.extractor.stream.Stream;
...
import dev.maxrave.pipepipe.extractor.stream.VideoStream;

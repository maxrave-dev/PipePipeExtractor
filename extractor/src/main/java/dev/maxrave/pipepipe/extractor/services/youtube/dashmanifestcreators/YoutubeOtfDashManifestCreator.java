package dev.maxrave.pipepipe.extractor.services.youtube.dashmanifestcreators;

import dev.maxrave.pipepipe.extractor.downloader.Response;
import dev.maxrave.pipepipe.extractor.services.youtube.DeliveryType;
import dev.maxrave.pipepipe.extractor.services.youtube.ItagItem;
import dev.maxrave.pipepipe.extractor.utils.ManifestCreatorCache;
...
import static dev.maxrave.pipepipe.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.ALR_YES;
import static dev.maxrave.pipepipe.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.RN_0;
import static dev.maxrave.pipepipe.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.SEGMENT_TIMELINE;
import static dev.maxrave.pipepipe.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.SQ_0;
import static dev.maxrave.pipepipe.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.buildAndCacheResult;
import static dev.maxrave.pipepipe.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.generateDocumentAndDoCommonElementsGeneration;
import static dev.maxrave.pipepipe.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.generateSegmentTemplateElement;
import static dev.maxrave.pipepipe.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.generateSegmentTimelineElement;
import static dev.maxrave.pipepipe.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.getInitializationResponse;
import static dev.maxrave.pipepipe.extractor.services.youtube.dashmanifestcreators.YoutubeDashManifestCreatorsUtils.setAttribute;
import static dev.maxrave.pipepipe.extractor.utils.Utils.EMPTY_STRING;
import static dev.maxrave.pipepipe.extractor.utils.Utils.isBlank;
